...
function estadia() {
  ...
  if (userText == "") {
    userText = document.getElementById("chat-box").value;
  }
  let userHtml = `<p class="userText"><span>  ${userText} </span></p>`;
...
function getBotResponse(input) {
  ...
  if (
    input == "Proceso de estadia" || input == "proceso de estadía" ||
    input == "estadia" ||
    input == "estadía"
  ) {
  ...
  if (
    input == "Proceso de estancia" || input == "proceso de estancia" ||
    input == "estancia" ||
    input == "estancias"
  ) {
  ...
  if (
    input == "Proceso de reinscripcion" || input == "proceso de reinscripción" ||
    input == "reinscripcion" ||
    input == "reinscripción"
  ) {
